        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" value="{{ old('delivery') }}" id="datepickerRewards" name="delivery" autocomplete="off" class="form-control" placeholder="{{ trans('misc.delivery') }}">
            </div>
