...
&& $response->finalized == 0
 	...
 	<div class="row margin-bottom-20">
		<div class="col-md-3">
			...
			<div class="col-md-3">
				<a class="btn btn-info btn-block mb-2 no-hover" href="{{ url('update/campaign',$response->id) }}">{{trans('misc.add_update')}}</a>
			</div>
...
==================================== -->
 <div class="col-md-5">
	 ...
	 <small class="btn-block mb-1"><a href="{{ url('category', $response->category->slug) }}" class="text-muted"><i class="far fa-folder-open"></i> {{ $response->category->name }}</a></small>
 		@endif
 	@endif
      ...
      <div class="modal-body">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-3 col-6 mb-3">
							<a data-toggle="modal" data-target="#embedModal" href="#" class="social-share text-muted d-block text-center h6" title="{{trans('misc.embed')}}">
	 ...
	 <div class="row">
		 <div class="col-md-8">
			 ...
			 <ul class="nav nav-tabs nav-fill">
			   <li class="nav-item active"><a href="#desc" aria-controls="home" role="tab" data-toggle="tab" class="nav-link active text-dark py-3"><strong>{{ trans('misc.story') }}</strong></a></li>
				 <li class="nav-item text-muted"><a href="#donations" aria-controls="home" role="tab" data-toggle="tab" class="nav-link text-dark py-3"><strong>{{ trans('misc.donations') }}</strong></a></li>
			 	 <li class="nav-item text-muted"><a href="#updates" aria-controls="home" role="tab" data-toggle="tab" class="nav-link text-dark py-3"><strong>{{ trans('misc.updates') }}</strong></a></li>
				 <li class="nav-item text-muted"><a href="#comments" aria-controls="home" role="tab" data-toggle="tab" class="nav-link text-dark py-3"><strong>{{ trans('misc.comments') }}</strong></a></li>
			 </ul>
	...
	swal(
		...
		$(document).on('click','#btn_copy_code', function(){
            ...
            document.execCommand("copy");
						$(btn).html('<i class="fa fa-check"></i> {{ trans('misc.copied') }}').removeClass('btn-primary').addClass('btn-success');
