      ...
      <div class="content-wrapper">
        ...
        <div class="col-lg-3">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <h3>{{ App\Helper::earningsNet('admin') }}</h3>
                  <p>{{ trans('misc.earnings_net') }}  ({{trans('users.admin') }})</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-3">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  <h3>{{ number_format($total_campaigns) }}</h3>
	                    ...
	                    <ul class="products-list product-list-in-box">
	                      @foreach( $users as $user )
		                      ...
		                      <div class="product-img">
		                        <img src="{{ asset('public/avatar').'/'.$user->avatar }}" class="img-circle h-auto" onerror="onerror" />
		                      </div>
