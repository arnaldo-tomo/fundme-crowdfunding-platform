                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <label class="padding-zero">
                          <input type="radio" name="show_navbar" @if( $data->show_navbar == '1' ) checked="checked" @endif value="1" checked>
                          {{ trans('misc.yes') }}
                        </label>
                      </div>
                      ...
                      <div class="radio">
                        <label class="padding-zero">
                          <input type="radio" name="show_navbar" @if( $data->show_navbar == '0' ) checked="checked" @endif value="0">
                          {{ trans('misc.no') }}
                        </label>
                      </div>
